...
| Titulo do Curso | Descrição do Curso | Link de acesso ao Curso | Plataforma | Idioma |
| --- | --- | --- | --- | --- |
| Sass placeholders: o jeito certos | Introdução ao pré processador Sass | <a href="https://www.udemy.com/course/sass-placeholders-o-jeito-certo//">Clique aqui</a> | Youtube | :us: |
<h2>Avançado</h2>
<hr/>
